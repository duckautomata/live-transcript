...
export const TranscriptProvider = ({children}) => {
    ...
    const transcriptValue = useMemo(() => ({ activeId, activeTitle, isLive, transcript, setActiveId, setActiveTitle, setIsLive, setTranscript }), [activeId, activeTitle, isLive, transcript]);
